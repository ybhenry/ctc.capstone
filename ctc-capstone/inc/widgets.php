...
class ctc_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'ctc_widget', // Base ID
            'ctc_widget', // Name
            array( 'description' => __( 'ctc_widget', 'text_domain' ), ) // Args
        );
    }
...
//register the widget
add_action( 'widgets_init', 'ctc_widget_areas' );

if ( ! function_exists( 'ctc_widget_areas' ) ) {

	/** Initializes themes widgets.*/
	function ctc_widget_areas() {

        //Header Nav
		register_sidebar(
			array(
				'name'          => __( 'Header Nav', 'ctc' ),
				'id'            => 'header-col-one',
				'description'   => __( 'Header navigation widget area', 'ctc' ),
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer 1', 'ctc' ),
				'id'            => 'footer-col-one',
				'description'   => __( 'Left Footer widget area', 'ctc' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer 2', 'ctc' ),
				'id'            => 'footer-col-two',
				'description'   => __( 'Right Footer widget area', 'ctc' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
